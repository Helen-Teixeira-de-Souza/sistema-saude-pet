...
class Consulta(models.Model):
    tutor = models.ForeignKey(Tutor, on_delete=models.CASCADE, related_name='consultas', null=True, blank=True)
    ...
    def __str__(self):
        nome_tutor = self.tutor.nome if self.tutor else 'Sem Tutor'
        return f"Consulta de {nome_tutor} em {self.data.strftime('%d/%m/%Y')}"
